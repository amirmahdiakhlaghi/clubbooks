...
<head>
    ...
    <scrip src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>

    <title>{{ __('AmdinPanel') }} - {{ $title ?? __('Home') }}</title>
    ...
    @script('https://cdn.jsdelivr.net/gh/alpinejs/alpine@v2.7.1/dist/alpine.min.js')
    @script("/assets/admin/js/ckeditor.min.js")
    @script("https://cdn.ckeditor.com/4.16.1/full/ckeditor.js")

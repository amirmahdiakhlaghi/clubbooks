 ...
 --}}
  ...
  <div id="newBooks" class="row justify-content-center col-12 col-lg-10 m-auto">
    ...
    <div class="col-12 text-right d-flex justify-content-between">
      ...
      <div>
          <h6 class="pt-4 pb-1 text-info"><a href="/new-books" style="color: #17a2b8!important;">مشاهده همه</a></h6>
      </div>
    </div>
  ...
  <div class="img-partone">
    <img src="/assets/images/tom-hermans.jpg" style="width:100%; height:450px">
  </div>
  <!-- -------------------- new article ------------------------- -->
  <div id="newBooks" class="row justify-content-center col-12 col-lg-10 m-auto">
    ...
    <div class="col-12 text-right d-flex justify-content-between">
      ...
      <div>
          <h6 class="pt-4 pb-1 text-info"><a href="/popular-books" style="color: #17a2b8!important;">مشاهده همه</a></h6>
      </div>
    </div>

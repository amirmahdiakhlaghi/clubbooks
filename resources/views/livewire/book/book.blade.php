    ...
    <div class="container">
            ...
            <div class="rightside col-12 col-md-5">
                ...
                <div class="breadcrumb">
                    <ul itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li itemtype="http://schema.org/ListItem" itemscope itemprop="itemListElement"><a href="#">{{$book->region}}</a></li>
                        <li itemtype="http://schema.org/ListItem" itemscope itemprop="itemListElement"><a href="#">{{$book->size}}</a></li>
        ...
        <div class="short-description">
            ...
            <div class="leftside col-12 col-sm-12 col-md-4">
                ...
                <p class="writer"><span><a href="{{$book->writer()->first()->name}}">نویسنده : <span>{{$book->writer()->first()->name}}</span></a></span></p>
            </div>
        </div>
        <section class="main-content">
            ...
            <div class="sidebar col-12 col-sm-12 col-md-4">
                <aside class="sidebar-aside">
                    ...
                    <div class="tags-layer" style="display:none;">

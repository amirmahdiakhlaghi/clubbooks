<tr x-data="{ modalIsOpen : false }">
    ...
    <td> {{ $category->icon }} </td>
    <td><a target="_blank" href="{{ asset($category->banner) }}"><img class="rounded-circle img-fluid" width="50" height="50" src="{{ asset($category->banner) }}" alt="banner"></a></td>
    ...
    @if(getCrudConfig('category')->delete or getCrudConfig('category')->update)
        <td>
            ...
            @if(getCrudConfig('category')->delete)
